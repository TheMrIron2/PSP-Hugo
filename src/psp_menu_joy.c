...
{
  psp_irdajoy_type      = HUGO.psp_irdajoy_type;
  psp_irdajoy_debug     = HUGO.psp_irdajoy_debug;
...
{
  /* Validate */
  HUGO.psp_irdajoy_type    = psp_irdajoy_type;
  HUGO.psp_irdajoy_debug   = psp_irdajoy_debug;
